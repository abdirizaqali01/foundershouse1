  ...
  useEffect(() => {
    ...
    textureLoader.load(imageSrc, texture => {
      ...
      if (planeRef.current) {
        ...
        planeRef.current.geometry = new THREE.PlaneGeometry(1, 1 / aspect, grid - 1, grid - 1);
      }
      handleResize();
    });
    ...
    const handleResize = () => {
      ...
      // Plane always fills width, height may overflow (cropped)
      if (plane) {
        plane.scale.set(containerAspect, containerAspect, 1);
      }

      // Camera frustum matches plane size
